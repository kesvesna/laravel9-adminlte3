            ...
            <form style="background: rgba( 255, 255, 255, 0.1 );
                ...
                <div class="mb-2 d-lg-flex justify-content-around">
                    ...
                    <div class="col-11 col-sm-10 col-md-10 col-lg-4 mx-auto">
                        ...
                        <select autofocus id="system_id" name="system_id" class="form-select form-select-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                ...
                <div class="mb-2 d-lg-flex justify-content-around">
                    <div class="col-11 col-sm-10 col-md-10 col-lg-4 mx-auto">
                        ...
                        <select id="building_id" name="building_id" class="form-select form-select-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                    ...
                    <div class="col-11 col-sm-10 col-md-10 col-lg-4 mx-auto">
                        ...
                        <select id="floor_id" name="floor_id" class="form-select form-select-sm" style="background: rgba( 255, 255, 255, 0.5 );">
