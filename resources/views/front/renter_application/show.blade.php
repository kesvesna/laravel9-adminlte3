                ...
                <form style="background: rgba( 255, 255, 255, 0.1 );
                    ...
                    <div class="row col-12 mx-auto row-cols-1 row-cols-md-2 row-cols-xxl-4">
                        <div class="col mt-3">
                            ...
                            <input disabled type="datetime-local" value="2017-06-01T08:30" id="date" name="date" class="form-control form-control-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                        </div>
                        <div class="col mt-3">
                            <label for="trk_id" class="form-label" style="color: white;">Торговый комплекс</label>
                            <select disabled id="trk_id" name="trk_id" class="form-select form-select-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                        ...
                        <div class="col mt-3">
                            ...
                            <select disabled id="system_id" name="system_id" class="form-select form-select-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                        ...
                        <div class="col mt-3">
                            ...
                            <select disabled id="status_id" name="status_id" class="form-select form-select-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                    ...
                    <div class="row col-12 mx-auto row-cols-1 row-cols-md-2 row-cols-xxl-4">
                        <div class="col mt-3">
                            ...
                            <br>
                            <input type="datetime-local" value="2017-06-01T08:30"  id="work_start_time" name="date" class="form-control form-control-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                        </div>
                        <div class="col mt-3">
                            <label class="mb-2" for="work_finish_time" style="color: white;">Дата и время окончания работ:</label>
                            <br>
                            <input type="datetime-local" value="2017-06-02T08:30" id="work_finish_time" name="work_finish_time" class="form-control form-control-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                        </div>
                    </div>
                    <div class="row col-12 mx-auto row-cols-1">
                        <div class="col mt-4">
                            <label for="comment" class="form-label" style="color: white;">Описание работ</label>
                            <textarea class="form-control form-control-sm" id="comment" name="comment" rows="2" style="background: rgba( 255, 255, 255, 0.5 );">Йа описание</textarea>
                        </div>
                    </div>
                    <div class="row col-12 mx-auto row-cols-1 row-cols-md-3 row-cols-xxl-3">
                        <div class="col mt-3">
                            ...
                            <input class="form-control form-control-sm" type="text" id="entity" placeholder="ООО Рога и копыта" style="background: rgba( 255, 255, 255, 0.5 );">
                        </div>
                        <div class="col mt-3">
                        ...
                        <div class="col mt-3">
                            ...
                            <select id="renter_brand_id" name="renter_brand_id" class="form-select form-select-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                    ...
                    <div class="row col-12 mx-auto row-cols-1">
                        <div class="col mt-3">
                            ...
                            <textarea class="form-control form-control-sm" id="persons_list" name="persons_list" rows="2" style="background: rgba( 255, 255, 255, 0.5 );">Иванов И.И., 89046137862; Петров П.П., 89046137862; Сидоров С.С.; 89046137862</textarea>
                        </div>
                    </div>
                    <div class="row col-12 mx-auto row-cols-1">
                        <div class="col mt-3">
                            <label for="responsible_person" class="form-label" style="color: white;">Ответственный</label>
                            <textarea class="form-control form-control-sm" id="responsible_person" name="responsible_person" rows="1" style="background: rgba( 255, 255, 255, 0.5 );">Алилуев А.А.; 89046137862</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row col-12 mx-auto row-cols-1 row-cols-md-3 row-cols-xxl-3">
                        <div class="col mt-3">
                            <button type="button" class=" btn btn-sm  btn-success col-12 mb-3">Согласовать</button>
                        </div>
                        <div class="col mt-3">
                            <button type="button" class=" btn btn-sm  btn-warning col-12 mb-3">Направить к инженерам</button>
                        </div>
                        <div class="col mt-3">
                            <button type="button" class=" btn btn-sm  btn-danger col-12 mb-3">Отклонить</button>
                        </div>
                        <hr>
                    </div>
                    <div class="row col-12 mx-auto row-cols-1">
