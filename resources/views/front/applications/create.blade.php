            ...
            <form style="background: rgba( 255, 255, 255, 0.1 );
                ...
                <div class="mb-3 d-lg-flex justify-content-around">
                    <div class="col-11 col-sm-10 col-md-10 col-lg-4 mx-auto">
                        ...
                        <select id="trk_id" name="trk_id" class="form-select form-select-sm form-select form-select-sm-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                            @forelse($trks as $trk)
                    ...
                    <div class="col-11 col-sm-10 col-md-10 col-lg-4 mx-auto mt-2">
                        ...
                        <select autofocus id="service_id" name="service_id" class="form-select form-select-sm form-select form-select-sm-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                ...
                <div class="mb-4">
                    <div class="col-11 col-xs-10 col-sm-10 col-md-10 mx-auto">
                        ...
                        <textarea class="form-control form-control-sm form-control form-control-sm-sm" id="comment" name="comment" rows="2" style="background: rgba( 255, 255, 255, 0.5 );">{{ old('comment') }}</textarea>
                    </div>
                </div>
                <div class="mb-4">
                    <div class="col-11 col-xs-10 col-sm-10 col-md-10 mx-auto">
                        <input class="form-control form-control-sm form-control form-control-sm-sm" type="file" id="files" multiple name="files[]" accept="image/*, video/*, audio/*">
                    </div>
                </div>
                <div class="mb-4">
                    <div class="col-11 col-xs-10 col-sm-10 col-md-10 mx-auto">
