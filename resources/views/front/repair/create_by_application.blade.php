            ...
            <form style="background: rgba( 255, 255, 255, 0.1 );
                ...
                <div class="mb-2 d-lg-flex justify-content-around">
                    <div class="col-11 col-sm-10 col-md-10 col-lg-4 mx-auto">
                        ...
                        <br>
                        <input value="{{date('Y-m-d\TH:i')}}" type="datetime-local" id="plan_date" name="plan_date" class="form-control form-control-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                    </div>
                    <div class="col-11 col-sm-10 col-md-10 col-lg-4 mx-auto">
                ...
                <div class="mb-3 d-lg-flex justify-content-around">
                    <div class="col-11 col-sm-10 col-md-10 col-lg-4 mx-auto mb-3">
                        ...
                        <select autofocus id="service_id" name="service_id" class="form-select form-select-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                    ...
                    <div class="col-11 col-sm-10 col-md-10 col-lg-4 mx-auto">
                        ...
                        <select autofocus id="responsible_user_id" name="responsible_user_id" class="form-select form-select-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                ...
                <div class="mb-4">
                    <div class="col-11 col-xs-10 col-sm-10 col-md-10 mx-auto">
                        ...
                        <textarea class="form-control form-control-sm" id="comment" name="comment" rows="2" style="background: rgba( 255, 255, 255, 0.5 );">{{ $application->comment }}</textarea>
                    </div>
                </div>
                <div class="mb-4">
                    <div class="col-11 col-xs-10 col-sm-10 col-md-10 mx-auto">
