        ...
        <div class="container pt-3" style="padding-bottom: 15vh;">
                ...
                <div class="row col-12 mx-auto row-cols-1 row-cols-md-2 row-cols-xxl-4">
                    <div class="col mt-3">
                        ...
                        <input disabled type="datetime-local" value="{{ $repair->currentHistory->plan_date }}" id="plan_date" name="plan_date" class="form-control form-control-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                    </div>
                    <div class="col mt-3">
                    ...
                    <div class="col mt-3">
                        ...
                        <select id="service_id" name="service_id" class="form-select form-select-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                    ...
                    <div class="col mt-3">
                        ...
                        <select id="status_id" name="status_id" class="form-select form-select-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                ...
                <div class="row col-12 mx-auto row-cols-1 mt-3">
                    <div class="col">
                        ...
                        <textarea disabled class="form-control form-control-sm" id="comment" name="comment" rows="2" style="background: rgba( 255, 255, 255, 0.5 );">{{ $repair->comment }}
                        </textarea>
                    </div>
                </div>
                ...
                <div class="row col-12 mx-auto row-cols-1 row-cols-md-2 row-cols-xxl-4">
                    <div class="col mb-3">
                        ...
                        <input disabled type="text" value="{{ $repair->currentHistory->user->name }}" id="user_id" name="user_id" class="form-control form-control-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                    </div>
                    ...
                    <div class="col mb-3">
                        ...
                        <input disabled type="text" value="{{ $repair->currentHistory->responsible_user->name }}" id="responsible_user_id" name="responsible_user_id" class="form-control form-control-sm" style="background: rgba( 255, 255, 255, 0.5 );">
                    </div>
                    @endif
                </div>
                ...
                @if($repair->currentHistory->repair_status->id == $repair::BY_PLAN || $repair->currentHistory->repair_status->id == $repair::BY_APPLICATION ||  $repair->currentHistory->repair_status->id == $repair::IN_PROGRESS)
                    <div class="mt-3 row col-12 mx-auto row-cols-1 row-cols-md-2 row-cols-xxl-4">
                        <form action="{{ route('front.acts.create_by_repair_all_done', $repair->id) }}" method="post">
                            @csrf
                            <div class="col">
                                <button type="submit" class=" btn btn-sm  btn-success col-12 mb-3"><b>Выполнен</b></button>
                            </div>
                        </form>
                        <form action="{{ route('front.acts.create_by_repair_not_completely_done', $repair->id) }}" method="post">
                            @csrf
                        <div class="col">
                            <button type="submit" class=" btn btn-sm  btn-warning col-12 mb-3">Выполнен частично</button>
                        </div>
                        </form>
                        <div class="col">
                            <button type="button" class=" btn btn-sm  btn-warning col-12 mb-3" data-bs-toggle="modal" data-bs-target="#appointRepairModal">Назначить исполнителя</button>
                        </div>
                        <div class="col">
                            <button type="button" class=" btn btn-sm  btn-danger col-12 mb-3" data-bs-toggle="modal" data-bs-target="#rejectRepairModal">Отклонить</button>
                        </div>
                    </div>
                @endif
