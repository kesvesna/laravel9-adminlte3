            ...
            <form style="background: rgba( 255, 255, 255, 0.1 );
                ...
                <div>
                    <div class="row col-12 mx-auto row-cols-1">
                        <div class="col">
                            <h4 style="color: white;">Ремонт № 34</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row col-12 mx-auto row-cols-1 mt-3">
                    <div class="col">
                        ...
                        <textarea disabled class="form-control" id="comment" name="comment" rows="2" style="background: rgba( 255, 255, 255, 0.5 );">Выполнить ремонт
                        </textarea>
                    </div>
                </div>
