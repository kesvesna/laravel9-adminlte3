...
@section('content')
    ...
    <form method="get" action="{{ route('admin.repairs.create') }}" class="mb-3">
        <div class="row">
            <h2>Ремонт</h2>
            <button class=" btn btn-sm  btn-success   ml-3" type="submit"><b>Запланировать ремонт</b></button>
        </div>
    </form>
    <hr>
        <a href="{{ route('admin.repairs.index') }}" class=" btn btn-sm  btn-success    btn-block mb-3"><b>Сбросить все
                фильтры</b></a>
        <div class="table-responsive">
            <table class="table table-striped table-hover table-bordered table-sm">
                ...
                <tr>
                    ...
                    <th>
                        <select class="form-control form-control-sm" name="repair_status_id" aria-label="select" onchange="this.form.submit()">
                            <option selected value="">Все</option>
