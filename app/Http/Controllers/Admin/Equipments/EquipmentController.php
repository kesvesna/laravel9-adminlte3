...
class EquipmentController extends Controller
{
    ...
    public function index(EquipmentFilterRequest $request)
    {
        ...
        $filter = app()->make(TrkRoomsFilter::class, ['queryParams' => array_filter($data)]);
