...
Route::name('front.')
    ...
    ->group(function () {
        ...
        Route::match(['get', 'post'],'acts/store_by_application_all_done/{application}', [FrontActController::class, 'store_by_application_all_done'])->name('acts.store_by_application_all_done');
